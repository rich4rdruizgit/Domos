...
import proyecto.com.domos.util.VerticalNavigationBottomBehavior;

/**
 * Created by Nikola D. on 3/15/2016.
 */
public final class ScrollNavigationBottomBehavior extends VerticalNavigationBottomBehavior {
    ...
    public ScrollNavigationBottomBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public static <V extends View> ScrollNavigationBottomBehavior from(@NonNull V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof ScrollNavigationBottomBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomNavigationBehavior");
        }
        return (ScrollNavigationBottomBehavior) behavior;
    }
    ...
    @Override
    public void onNestedVerticalOverScroll(CoordinatorLayout coordinatorLayout, BottomNavigationView child, @ScrollDirection int direction, int currentOverScroll, int totalOverScroll) {
    }

    @Override
    public void onDirectionNestedPreScroll(CoordinatorLayout coordinatorLayout, BottomNavigationView child, View target, int dx, int dy, int[] consumed, @ScrollDirection int scrollDirection) {
    ...
    @Override
    protected boolean onNestedDirectionFling(CoordinatorLayout coordinatorLayout, BottomNavigationView child, View target, float velocityX, float velocityY, @ScrollDirection int scrollDirection) {
        handleDirection(child, scrollDirection);
        return true;
    }
    ...
    public void setHidden(BottomNavigationView view, boolean bottomLayoutHidden) {
