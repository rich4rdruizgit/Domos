...
public abstract class VerticalNavigationBottomBehavior extends CoordinatorLayout.Behavior<BottomNavigationView> {
    ...
    public VerticalNavigationBottomBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public VerticalNavigationBottomBehavior() {
        super();
    }
   ...
   */
     ...
     */
    public abstract void onNestedVerticalOverScroll(CoordinatorLayout coordinatorLayout, BottomNavigationView child, @ScrollDirection int direction, int currentOverScroll, int totalOverScroll);

    /**
     * @param scrollDirection Direction of the overscroll: SCROLL_DIRECTION_UP, SCROLL_DIRECTION_DOWN
     */
    public abstract void onDirectionNestedPreScroll(CoordinatorLayout coordinatorLayout, BottomNavigationView child, View target, int dx, int dy, int[] consumed, @ScrollDirection int scrollDirection);
    ...
    @Override
    public void onNestedScrollAccepted(CoordinatorLayout coordinatorLayout, BottomNavigationView child, View directTargetChild, View target, int nestedScrollAxes) {
    ...
    protected abstract boolean onNestedDirectionFling(CoordinatorLayout coordinatorLayout, BottomNavigationView child, View target, float velocityX, float velocityY, @ScrollDirection int scrollDirection);
    ...
    @Override
    public WindowInsetsCompat onApplyWindowInsets(CoordinatorLayout coordinatorLayout, BottomNavigationView child, WindowInsetsCompat insets) {

        return super.onApplyWindowInsets(coordinatorLayout, child, insets);
    }

    @Override
    public Parcelable onSaveInstanceState(CoordinatorLayout parent, BottomNavigationView child) {
